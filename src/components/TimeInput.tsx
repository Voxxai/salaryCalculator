    ...
    return (
      <div className="flex items-center space-x-2">
        ...
        <input
          ...
          placeholder="8"
          className="w-20 px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900 text-center"
          inputMode="decimal"
          aria-label="Hours"
          min="0"
          max="99"
